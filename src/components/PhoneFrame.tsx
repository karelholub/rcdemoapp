...
export function PhoneFrame({ children }: { children: ReactNode }) {
  return (
    <div className="mx-auto w-full max-w-[390px] rounded-[2.25rem] border border-white/15 bg-black p-3 shadow-2xl shadow-black/50">
      <div className="relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#0a111b]">
        <div className="flex h-8 items-center justify-between bg-black/20 px-6 text-[11px] text-slate-200">
          <span>9:41</span>
